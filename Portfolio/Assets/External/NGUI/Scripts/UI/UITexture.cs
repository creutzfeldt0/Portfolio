...
public class UITexture : UIBasicSprite
{
    ...
    /// </summary>
    public float distortionTimer = 0;
    ...
    protected override void OnUpdate ()
	{
        ...
        switch (type)
        {
            ...
            case Type.HitRB:
            case Type.HitRT:
                distortionTimer += Time.deltaTime * 1.5f;
                distortionRatioDirChangeCount = (int)distortionTimer;
                distortionRatio = Mathf.Abs(Mathf.Sin((distortionTimer) * 0.5f));
                break;
        }
