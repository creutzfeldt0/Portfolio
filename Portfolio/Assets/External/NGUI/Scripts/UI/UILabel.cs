...
public class UILabel : UIWidget
{
    ...
    public bool _autoReturnLineSkip = false;
	...
	public bool Wrap (string text, out string final, int height)
	{
		...
		bool retVal = NGUIText.WrapText(text, out final, false, _autoReturnLineSkip);
		NGUIText.bitmapFont = null;
		NGUIText.dynamicFont = null;
		return retVal;
	}
    ...
    public void SetLocalizeSize()
    {
        /*
        if (mFont != null && mFont.name.Contains("fontMain"))
        {
            if (backupSize == 0)
            {
                backupSize = fontSize;
            ...
            if (Localization.language.Contains("English"))
            {
                this.fontSize = (int)(backupSize * 1.9f);
            }
            else if (Localization.language.Contains("Korean"))
            {
                this.fontSize = backupSize;
            }
            else
            {
                this.fontSize = (int)(backupSize * 1.06f);
            }
        }
        */
    }
