...
/// </summary>
[Serializable]
public class SpineFXObj_Const_Skin : SpineFXObjBase
{
    /// <summary>
    ...
    private void Update()
    {
        ...
        FixedUpdate_Const_Skin();
        
        FixedUpdate_BoneChase();
    }

    private void FixedUpdate_Const_Skin()
    {
        if ( null == m_SkeletonMecanim.skeleton.Skin ||
             m_SkeletonMecanim.skeleton.Skin.Name != m_FXData.FXTypeData )
        {
            m_Transform_FX.gameObject.SetActive(false);
            return;
        }
